...
class MqttService extends EventEmitter {
  ...
  start() {
    ...
    this.mqttClient.on("connect", () => {
      ...
      logger.info(`MQTT connected to ${this.mqttConfig.url} (after ${this.reconnectAttempts} reconnect attempt(s))`);
      this.reconnectAttempts = 0;
    ...
    this.mqttClient.on("reconnect", () => {
      ...
      logger.warn(
        `MQTT client reconnecting (attempt #${this.reconnectAttempts}, period ${this.mqttConfig.options.reconnectPeriod}ms).`
      );
    });
