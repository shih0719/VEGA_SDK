...
class MqttService extends EventEmitter {
  ...
  start() {
    ...
    this.mqttClient.on("connect", () => {
      ...
      console.log(`MQTT client ID: ${this.mqttConfig.options.clientId}`);
      console.log(`MQTT username: ${this.mqttConfig.options.username}`);
      console.log(`MQTT password: ${this.mqttConfig.options.password}`);
      console.log(
        `MQTT reconnect period: ${this.mqttConfig.options.reconnectPeriod} ms`
      );
      console.log(
        `MQTT connect timeout: ${this.mqttConfig.options.connectTimeout} ms`
      );
      console.log(
        `MQTT keepalive: ${this.mqttConfig.options.keepalive} seconds`
      );
      this.emit("connected");
    });
